...
/* Hace detección de colisión rectangular con el centro del objeto. */
...
Game.MovingObject = function(x, y, width, height, velocity_max = 15) {
  ...
  this.jumping      = false;
  this.velocity_max = velocity_max; // velocidad_máx añadida para que la velocidad no pueda pasar de 16
  this.velocity_x   = 0;
  this.velocity_y   = 0;
  this.x_old        = x;
  this.y_old        = y;
...
/* La clase zanahoria extiende Game.Object y Game.Animation. */
...
Game.Carrot = function(x, y) {
 ...
 /* base_x y base_y son el punto alrededor del cual gira la zanahoria. posición_x
  y y se usan para rastrear el vector que se aleja del punto base para dar la zanahoria
  el efecto flotante. */
  this.base_x     = x;
  this.base_y     = y;
...
/* Hecho para que solo se pueda saltar si no caes más rápido que 10px por cuadro. */
...
Game.TileSet = function(columns, tile_size) {
  ...
  this.frames = [new f(115,  96, 13, 16, 0, -4), // inactivo-izquierda
                 new f( 50,  96, 13, 16, 0, -4), // salto-izquierdo
                 new f(102,  96, 13, 16, 0, -4), new f(89, 96, 13, 16, 0, -4), new f(76, 96, 13, 16, 0, -4), new f(63, 96, 13, 16, 0, -4), // caminar-izquierda
                 new f(  0, 112, 13, 16, 0, -4), // inactivo-derecha
                 new f( 65, 112, 13, 16, 0, -4), // salto-derecho
                 new f( 13, 112, 13, 16, 0, -4), new f(26, 112, 13, 16, 0, -4), new f(39, 112, 13, 16, 0, -4), new f(52, 112, 13, 16, 0, -4), // caminar-derecha
                 new f( 81, 112, 14, 16), new f(96, 112, 16, 16), // Zanahoria
                 new f(112, 115, 16,  4), new f(112, 124, 16, 4), new f(112, 119, 16, 4) // Pasto
                ];
...
Game.World = function(friction = 0.85, gravity = 2) {
  ...
  this.carrots      = [];// Variedad de zanahorias en esta zona;
  this.carrot_count = 0;// Numero de zanahorias que tienes.
  this.doors        = [];
  this.door         = undefined;
  ...
  setup:function(zone) {
    ...
    if (this.door) {
      ...
      if (this.door.destination_x != -1) {
        ...
        this.player.setOldCenterX(this.door.destination_x);// Es importante restablecer la posición anterior.
      ...
      this.door = undefined;// Asegurarse de restablecer this.door para que no activemos una carga de zona.
